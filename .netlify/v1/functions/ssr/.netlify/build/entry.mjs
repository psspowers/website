...
import { manifest } from './manifest_B6jg_8pU.mjs';
...
const _page8 = () => import('./pages/partner-with-us.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/partner-with-us.astro", _page8],
...
const _args = {
    "middlewareSecret": "f3eb6a26-ba32-4e6e-994e-9541f41eeeec"
};
