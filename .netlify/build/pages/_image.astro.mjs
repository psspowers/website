...
import { A as AstroError, f as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, E as ExpectedImageOptions, g as ExpectedImage, h as ExpectedNotESMImage, r as resolveSrc, i as isRemoteImage, j as isESMImportedImage, k as isLocalService, D as DEFAULT_HASH_PROPS, l as InvalidImageService, m as ImageMissingAlt, n as isRemoteAllowed } from '../assets/astro/assets-service.BMC2qkj4.js';
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, s as spreadAttributes, b as createAstro } from '../assets/astro/server.YX3pkTnX.js';
import 'html-escaper';
import 'clsx';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../assets/astro/assets-service.BMC2qkj4.js'
    ).then(n => n.s).catch((e) => {
...
}, "/tmp/cc-agent/41679351/project/node_modules/astro/components/Image.astro", undefined);
...
}, "/tmp/cc-agent/41679351/project/node_modules/astro/components/Picture.astro", undefined);
