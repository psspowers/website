...
import 'kleur/colors';
import 'html-escaper';
import { $ as $$Layout } from '../assets/Layout.DvVnBsLp.js';
import { $ as $$AnimatedStats } from '../assets/AnimatedStats.COJCaFeN.js';
import { $ as $$OptimizedImage } from '../assets/OptimizedImage.B7LfDcbv.js';
/* empty css                                   */
import { f as fetchProjects } from '../assets/projectsDbService.hnGeBVV2.js';
...
const $$Projects = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Projects Portfolio - Pss.Orange", "description": "Explore Pss.Orange's portfolio of renewable energy projects across Asia. Featuring solar, wind, and energy storage solutions.", "image": "/project-images/maxion.webp", "type": "website", "data-astro-cid-aid3sr62": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="pt-20" data-astro-cid-aid3sr62> <!-- Hero --> <section class="dark-gradient-header" data-astro-cid-aid3sr62> <div class="max-w-screen-2xl mx-auto px-6 lg:px-8" data-astro-cid-aid3sr62> <div class="max-w-4xl text-white" data-aos="fade-up" data-astro-cid-aid3sr62> <p class="text-emerald-400 text-sm font-semibold tracking-widest uppercase mb-4" data-astro-cid-aid3sr62>Our Work</p> <h1 class="font-display text-4xl md:text-6xl font-bold tracking-tight mb-6" data-astro-cid-aid3sr62>
