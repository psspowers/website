/* empty css                                */
import { c as createComponent, r as renderTemplate, d as renderComponent, m as maybeRenderHead, a as addAttribute } from '../assets/astro/server.CUvW1WRH.js';
import 'kleur/colors';
import 'html-escaper';
import { $ as $$OptimizedImage, a as $$Layout } from '../assets/Layout.D9HdpgRn.js';
import { s as supabase } from '../assets/supabase.DTyfQ36f.js';
import { $ as $$LinkText } from '../assets/LinkText.B-D35-Ih.js';
...
const $$News = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Latest News & Updates - PSS Powers", "description": "Stay informed about PSS Powers' latest projects, partnerships, and achievements in renewable energy.", "image": "/News_Images/2025-02_2025-02-15_isq-partnership-announcement.jpg", "type": "article" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="pt-20"> <!-- Hero --> <section class="dark-gradient-header"> <div class="max-w-screen-2xl mx-auto px-6 lg:px-8"> <div class="max-w-3xl text-white" data-aos="fade-up"> <p class="text-emerald-400 text-sm font-semibold tracking-widest uppercase mb-4">Press & Media</p> <h1 class="font-display text-4xl md:text-5xl font-bold tracking-tight mb-6">
Latest News & Updates
